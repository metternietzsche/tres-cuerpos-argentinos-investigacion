...
**Versión:** v0.2 — publicación de trabajo  
...
**Origen documental:** mensajes presidenciales publicados en los Diarios de Sesiones de la HCDN, 1983–2025; contrapunto separado de Perón 1946 y 1954, reconstruido desde la pipeline documental alternativa del proyecto  
**Corpus:** HCDN v0.1 · 51 documentos · 10 personas · 12 unidades `actor × mandato`  
**Linaje metodológico:** NB10 (parejas y línea de base) → NB12 (caso Milei) → NB13 (auditoría abductiva de dirección) → NB14 (mapa orbital v0.2)  
...
**Cita sugerida:** Bustos Frati, Alexandra (2026). *El problema de los tres cuerpos argentinos: una lectura orbital del presidencialismo argentino*. Whitepaper v0.2.  
**Licencia del texto y las figuras:** CC BY-NC 4.0.

> **Condición de lectura:** La versión v0.2 incorpora el cambio metodológico NB12–NB14 y publica el mapa por mandato. Todos los perfiles siguen siendo hipótesis revisables. La unidad es `actor × mandato`, la pareja y la dirección se informan por capas, y toda dirección revisada requiere validación independiente. El mapa integrado v1 continúa sujeto a las condiciones de § 10 y § 11.

---

### Antes de leer: qué es NB13

**NB13 es la Auditoría abductiva de dirección del corpus democrático 1983–2025.** Parte de un problema que los conteos no resuelven: el vector con más masa proposicional no siempre es el que organiza al otro. NB13 conserva la pareja detectada por NB10 y reabre sólo la flecha.

La auditoría observa seis funciones de encuadre —tiempo, problema, autoridad, sujeto, telos y sacrificio— y distingue esas funciones de los medios y las pruebas técnicas. Se aplica a los 51 documentos del corpus HCDN, organizados en 10 personas y 12 unidades `actor × mandato`. Milei es el caso de calibración heredado de NB12; Perón no ingresa porque su pipeline no comparte una escala numérica con HCDN.

La notación debe leerse así: `A→B` significa que la evidencia favorece que A encuadre y B instrumente; `A↔B` significa que la evidencia no autoriza una jerarquía; **dirección revisada** señala que NB13 cambia la flecha de la línea de base y que esa nueva lectura debe ser validada de manera independiente. NB13 no clasifica presidentes como tipos fijos: examina relaciones entre vectores dentro de documentos y mandatos.
...
El análisis empírico se apoya en el corpus de discursos presidenciales ante la Honorable Cámara de Diputados de la Nación Argentina (HCDN) del período democrático 1983–2025: 51 documentos de apertura legislativa y asunción presidencial, 10 personas y **12 unidades actor × mandato**, procesados mediante vectores proposicionales calibrados y reexaminados con una auditoría estructural abductiva. Menem y Cristina Fernández de Kirchner aportan dos mandatos cada uno; Alfonsín aporta un único mandato cuya inestabilidad documental se conserva como trayectoria. Los períodos de Perón (1946 y 1954) se presentan como contrapunto cualitativo metodológicamente separado. El discurso de Perón del 12 de octubre de 1973 permanece excluido.

Los hallazgos centrales son cinco. Primero: el 86% de los documentos del período democrático conserva a tecnocracia y paternalismo como pareja principal; el bump no altera esa estructura del campo. Segundo: la masa proposicional no basta para decidir qué vector organiza al otro. En las 12 unidades, NB13 preserva cinco flechas, deja cinco direcciones indeterminadas y propone dos direcciones revisadas. Tercero: la separación por mandato revela que CFK I parte de `TEC→PAT`, mientras CFK II parte de `PAT→TEC`; el promedio personal ocultaba esa rotación. Menem conserva la base `PAT→TEC` en ambos mandatos, pero sólo Menem I queda estructuralmente preservado. Cuarto: Milei conserva la pareja MES–TEC, pero NB12 y NB13 favorecen provisionalmente `MES→TEC`: MES organiza el tiempo político y TEC gobierna la realización y la prueba. Quinto: Macri aparece como dirección revisada `PAT→TEC`, todavía pendiente de revisión ciega. La inestabilidad de Alfonsín y la disociación discurso/gobierno de Menem siguen siendo hallazgos centrales.

Los caveats son parte integrante del argumento, no notas al pie. No existen clasificaciones tipológicas finales. El discurso presidencial formal no es el gobierno completo. La auditoría estructural es un instrumento de screening diseñado después del caso Milei: orienta lectura, no prueba causalidad, y sus resultados no se consolidan sin revisión independiente. No existe puente numérico entre la pipeline de Perón y el corpus HCDN. El mapa orbital v0.2 corrige la unidad y reabre la flecha; no es todavía el mapa integrado v1.
...
Este vector no es necesariamente religioso. Puede ser secular, revolucionario, moral, nacional, anti-decadente. No equivale a autoritarismo ni a populismo en sentido técnico. En el corpus democrático HCDN, el mesianismo como vector primario aparece casi exclusivamente en contextos de ruptura institucional aguda: hiperinflación, colapso del Estado, asunciones de emergencia. La excepción provisoria es Milei —cuyo corpus es todavía insuficiente para confirmar si el patrón se sostiene fuera de esos contextos.

La identificación del mesianismo no puede quedar limitada a las categorías léxicas usadas como proxies en la primera pipeline. Los proxies son huellas de reconocimiento, no la definición del vector. NB12–NB13 amplían la prueba hacia su función estructural: régimen temporal, construcción del problema y del enemigo, fuente de autoridad, sujeto convocado, telos, sacrificio y no-retorno. Ninguna palabra aislada —religión, futuro, crisis, pueblo— basta. La hipótesis mesiánica gana fuerza cuando esas funciones forman una arquitectura recurrente y cuando retirar MES altera el sentido histórico del programa aun si permanecen sus medidas técnicas.
...
La dirección de la configuración importa, pero el bump distingue dos preguntas que v0.1 trataba como una sola. La **base proposicional** pregunta qué vector acumula más señal calibrada. La **dirección estructural** pregunta qué vector organiza tiempo, problema, autoridad, sujeto, telos y sacrificio, y cuál especifica medios y prueba. "Paternalismo + tecnocracia" y "tecnocracia + paternalismo" comparten pareja pero no jerarquía. Si la evidencia estructural no supera el margen de decisión, la notación correcta es `PAT↔TEC`, no una flecha forzada.

Menem I conserva `PAT→TEC`; Menem II queda `PAT↔TEC`. Macri parte de `TEC→PAT` en la base NB10, pero NB13 propone `PAT→TEC` como dirección revisada: PAT fijaría destinatario y horizonte, mientras TEC gobernaría medios y prueba. Esa lectura no se presenta aquí como resultado canónico; requiere codificación ciega.
...
La ambigüedad no es un defecto del modelo. En varios casos —Kirchner, Alberto Fernández— la ambigüedad de vector en el corpus es el hallazgo: el discurso presidencial combina genuinamente los dos registros del díada sin que uno domine de manera estable. Eso es una propiedad del discurso, no un error de medición.

> **Figura 1. Mapa orbital por actor × mandato — base y dirección estructural**
> Fuente: `../empirical/mapa_orbital_v0_2/figures/MAPA_ORBITAL_DIRECTION_MATRIX_v0_2.png` (NB14)
> Uso: comparar la línea de base proposicional con la dirección estructural revisada en 12 unidades.
> Caveat: 51 documentos, 10 personas, 12 unidades. Las direcciones revisadas requieren validación independiente. No incluye Perón.

---

### 4. Corpus y método

El corpus primario del proyecto es el conjunto de discursos presidenciales ante la Honorable Cámara de Diputados de la Nación Argentina (HCDN) del período democrático 1983–2025. Incluye mensajes de apertura de sesiones ordinarias y discursos de asunción: documentos que marcan el inicio del año legislativo o del mandato, pronunciados ante el Congreso reunido en asamblea, y publicados en el Diario de Sesiones.

La elección de este corpus no es arbitraria. Los mensajes de apertura legislativa son el género discursivo presidencial más formalizado, más comparables entre actores, y más sistemáticamente disponible a lo largo del período. No son el único discurso presidencial —excluyen cadenas nacionales, discursos electorales, comunicación informal— pero tienen la ventaja de la regularidad. El corpus cubre 51 documentos de 10 personas que ejercieron la Presidencia, organizados en 12 unidades actor × mandato: Alfonsín; Menem I y II; De la Rúa; Rodríguez Saá; Duhalde; Kirchner; CFK I y II; Macri; Alberto Fernández; Milei.
...
NB10 produce la línea de base interpretiva del corpus democrático: configuraciones documentales, transiciones, fortaleza atractora y niveles de cautela. NB12 reconstruye abductivamente la dirección interna de la pareja MES–TEC en tres discursos de Milei. NB13 generaliza la auditoría de dirección a los 51 documentos, conserva la pareja NB10 y reabre sólo la flecha. NB14 corrige la unidad `actor × mandato` y construye el mapa v0.2. NB10 conserva autoridad para la pareja y la distribución documental; NB12–NB14 incorporan la capa funcional y estructural de la dirección.

La auditoría descubrió además un problema de fuente en Rodríguez Saá. El archivo de 2001 contiene la sesión legislativa completa y 198 intervenciones ajenas antes del mensaje presidencial. NB13 limita ese caso a los segmentos 1084–1112. El recorte elimina un falso flip contaminado por otros oradores y deja `PAT↔MES`. La corrección debe propagarse a NB04/NB10 antes de cualquier promoción.
...
El hallazgo más robusto del corpus democrático HCDN 1983–2025 es la persistencia de la pareja tecnocracia/paternalismo: el **86% de los 51 documentos** del período contiene una de sus dos direcciones como configuración primaria y secundaria. Esta cifra es transversal a coaliciones, orientaciones y períodos históricos radicalmente distintos. El bump conserva el hallazgo de pareja, pero ya no identifica automáticamente la configuración modal `PAT→TEC` con la dirección estructural del campo.

La distribución completa es:

| Configuración | Documentos | Personas NB10 |
|---|---|---|
...
Esta tabla es documental y proposicional. No debe trasladarse sin mediación a una tabla de mandatos. En la síntesis v0.2, diez de las doce unidades conservan la pareja TEC–PAT, pero sólo cinco de las doce flechas totales quedan preservadas por el screening estructural; cinco quedan indeterminadas y dos son direcciones revisadas. La pareja es más robusta que su orden interno.
...
La co-presencia del díada tec/pat no es una anomalía argentina ni un artefacto metodológico. Es una propiedad documentable del discurso presidencial formal del período. Lo que la hace analíticamente interesante es que aparece bajo condiciones tan dispares —reforma neoliberal y kirchnerismo, convertibilidad y cepo cambiario— que no puede explicarse por la orientación del gobierno. Requiere una explicación que tenga en cuenta el campo retórico disponible para el presidencialismo como institución, independientemente del actor que lo ocupa.

---

### 6. Familias de configuración en democracia

El corpus HCDN muestra seis familias de configuración. Las dos del díada tec/pat concentran el 86% de los documentos. Las cuatro restantes son numéricamente minoritarias pero analíticamente significativas: identifican los contextos en que el mesianismo emerge como vector activo.

**Paternalismo + tecnocracia.** Es la configuración documental más frecuente en la línea de base (49%, 7 personas). En esta familia, el lenguaje de protección social, tutela estatal e interpelación al pueblo como sujeto de derechos acumula más señal que la tecnocracia. La auditoría v0.2 exige una segunda pregunta: si esa ventaja cuantitativa también organiza la arquitectura. Menem I es el caso más robusto: `PAT→TEC` queda preservado en cinco de seis pruebas de sensibilidad y sólo una queda indeterminada. Menem II conserva la pareja pero queda `PAT↔TEC`.

**Tecnocracia + paternalismo.** La cara inversa en la línea de base documental (37%, 8 personas). La separación por mandato muestra que no puede atribuirse esta dirección a CFK como persona: CFK I parte de `TEC→PAT` y queda estructuralmente `TEC↔PAT`; CFK II parte de `PAT→TEC` y preserva esa dirección. Macri parte de `TEC→PAT`, pero la lectura estructural propone el flip `PAT→TEC`. Por eso esta familia debe presentarse como dirección proposicional de documentos, no como clasificación consolidada de mandatos.

**Tecnocracia + mesianismo / mesianismo + tecnocracia.** La pareja más distintiva del corpus aparece en el discurso extraordinario de Alfonsín de 1988 y en Milei. En Alfonsín, el empate exacto de masa y el contexto Carapintada impiden estabilizar una flecha. En Milei, NB10 registra `TEC→MES` por volumen, pero NB12 favorece `MES→TEC` en los discursos de 2023, 2024 y 2025: MES define decadencia, enemigo, umbral, misión y telos; TEC convierte esa misión en diagnóstico, instrumentos y resultados; los resultados técnicos vuelven como prueba de la promesa. NB13 reproduce la inversión en cinco de seis controles. La pareja es robusta como hipótesis; su dirección permanece bajo revisión y su generalización al actor continúa limitada.

**Paternalismo + mesianismo.** La pareja aparece en la línea de base de registros de ruptura institucional: Rodríguez Saá en diciembre de 2001 y la inauguración de Duhalde en enero de 2002. En Rodríguez Saá, la dirección previa estaba contaminada por intervenciones legislativas ajenas; con la ventana presidencial correcta, NB13 obtiene `PAT↔MES`, pero hereda la pareja NB10 y no la reestima. En Duhalde, la trayectoria posterior retorna al par TEC–PAT. La familia sigue siendo una hipótesis situacional; el caso Saá debe recalcularse upstream antes de sostenerla.
...
> **Figura 2. Capa documental de dirección**
> Fuente: `../empirical/mapa_orbital_v0_2/figures/MAPA_ORBITAL_DOCUMENT_LAYER_v0_2.png` (NB14)
> Uso: mostrar que la trayectoria no se reduce al promedio del mandato y localizar documentos preservados, indeterminados, sin díada o con dirección revisada.
> Caveat: screening estructural; una inversión documental no escala automáticamente al mandato.

> **Figura 3. Mapa de lectura editable del campo**
> Fuente: `../empirical/mapa_orbital_v0_2/figures/MAPA_ORBITAL_ARGENTINO_v0_2.png` (NB14; fuente editable disponible en formato Draw.io)
> Uso: distinguir el núcleo TEC–PAT de las parejas PAT–MES y MES–TEC, con las 12 unidades y sus estados.
> Caveat: no representa distancias métricas entre presidentes ni posiciones tipológicas fijas.

| Unidad | n | Base | Dirección estructural | Estado |
|---|---:|---|---|---|
| Alfonsín (1983–1989) | 8 | `TEC→PAT` | `TEC↔PAT` | indeterminada |
| Menem I (1989–1995) | 6 | `PAT→TEC` | `PAT→TEC` | preservada |
| Menem II (1995–1999) | 5 | `PAT→TEC` | `PAT↔TEC` | indeterminada |
| De la Rúa (1999–2001) | 3 | `PAT→TEC` | `PAT↔TEC` | indeterminada |
| Rodríguez Saá (2001) | 1 | `PAT→MES` | `PAT↔MES` | indeterminada |
| Duhalde (2002–2003) | 3 | `PAT→TEC` | `PAT→TEC` | preservada |
| Néstor Kirchner (2003–2007) | 5 | `PAT→TEC` | `PAT→TEC` | preservada |
| CFK I (2007–2011) | 4 | `TEC→PAT` | `TEC↔PAT` | indeterminada |
| CFK II (2011–2015) | 5 | `PAT→TEC` | `PAT→TEC` | preservada |
| Macri (2015–2019) | 5 | `TEC→PAT` | `PAT→TEC` | dirección revisada |
| Alberto Fernández (2019–2023) | 4 | `PAT→TEC` | `PAT→TEC` | preservada |
| Milei (2023–) | 2 NB10 / 3 NB12 | `TEC→MES` | `MES→TEC` | dirección revisada |
...
NB13 deja el agregado del mandato en `TEC↔PAT` (margen 0.028; dos controles preservan y cuatro quedan indeterminados). Esa fórmula no reemplaza la secuencia: confirma que el promedio no autoriza una flecha estable. Alfonsín fue un solo mandato; dividirlo en unidades ficticias para estabilizar el mapa destruiría precisamente el hallazgo de trayectoria.

#### 7.2 Menem I y Menem II: continuidad de pareja, diferencia de certeza

*TIER_1 · Menem I n=6 · Menem II n=5 · caution v0.2: medium por unidad*
...
La auditoría estructural diferencia su certeza. Menem I preserva `PAT→TEC` (margen 0.063; cinco de seis controles preservan). Menem II queda `PAT↔TEC` (margen 0.020; cinco de seis controles indeterminan). No corresponde describir diez años como una única flecha de baja cautela: la continuidad de pareja es robusta, pero la jerarquía del segundo mandato no lo es.

La disociación entre registro discursivo paternalista y orientación gubernamental reformista permanece. La apertura de 1992 concentra el score de paternalismo más alto del corpus. El caso Menem sigue siendo la evidencia más fuerte de que discurso y política de Estado son dimensiones separables; el bump sólo impide confundir esa tesis con una estabilidad direccional uniforme entre mandatos.

#### 7.3 CFK I y CFK II: la rotación que ocultaba el promedio personal

*TIER_1 · CFK I n=4 · CFK II n=5 · caution v0.2: medium por unidad*
...
La capa estructural añade cautela. CFK I queda `TEC↔PAT` (margen 0.032; cuatro controles indeterminan y dos invierten). La apertura de marzo de 2011 es un flip documental bajo revisión `PAT→TEC`, pero no alcanza para fijar la dirección del mandato. CFK II preserva `PAT→TEC` (margen 0.042; tres controles preservan y tres indeterminan). La pareja TEC–PAT es estable; su jerarquía varía por mandato.
...
El perfil de Macri parte de la corrección de metadatos de 2026-04-29: la asunción de Alberto Fernández fue separada de su corpus. La línea de base corregida (n=5) es `TEC→PAT`. NB13 propone invertirla a `PAT→TEC` (margen 0.059; cuatro de seis controles invierten y dos indeterminan). En 2016, “la Argentina que viene” se define mediante acuerdo, cuidado, pobreza cero y unión; en 2019, el equilibrio fiscal se presenta como justicia social y “pobreza cero” como horizonte. La lectura revisada es que PAT fija destinatario y telos, mientras TEC gobierna medios y prueba.
...
El perfil es TIER_3 tanto por la corrección de patch pendiente de re-run como porque la nueva dirección nació de un screening no ciego. No debe presentarse `PAT→TEC` como conclusión hasta una codificación independiente, ni compararse con el perfil pre-corrección.
...
*TIER_3 · n=2 en NB10 · tres discursos en NB12 · dirección revisada*
...
La explicación provisional es un **acoplamiento asimétrico recursivo**. MES define decadencia, enemigo, umbral, misión, sacrificio y telos. TEC convierte esa misión en diagnóstico, instrumentos y resultados. Después, los resultados técnicos se presentan como prueba de que la promesa mesiánica era verdadera. Sin TEC queda una misión sin programa; sin MES permanece un ajuste, pero desaparecen el tiempo histórico, la autorización sacrificial y el destino. NB13 reproduce la inversión a nivel de unidad en cinco de seis controles y deja uno indeterminado.
...
La cautela sigue siendo ineludible. NB12 usa tres discursos, pero sólo dos integran los scores canónicos NB10; el caso Milei se usó para diseñar el instrumento estructural; no existe validación entre codificadores; y una apertura de 2026 ampliaría la prueba fuera de muestra. `MES→TEC` es una dirección revisada robusta dentro del experimento, no un tipo definitivo de actor.

#### 7.7 Rodríguez Saá: una dirección contaminada que debe quedar abierta

*TIER_3 · n=1 · caution: high · fuente recortada en NB13*

La base NB10 registra `PAT→MES`, pero el archivo contiene una sesión completa. El screening inicial tomó como presidenciales palabras de otros 198 intervinientes, entre ellos Elisa Carrió, y produjo un falso flip. Al restringir el mensaje real a los segmentos 1084–1112, Rodríguez Saá queda `PAT↔MES` (margen 0.038). NB13 conserva la pareja por diseño y sólo reabre su dirección: no demuestra que PAT–MES sobreviva a un recálculo completo. Ninguna versión canónica debe usar este caso sin propagar primero el recorte a NB04/NB10.
...
**Perón no aparece en el mapa de actores HCDN.** La grilla democrática del proyecto cubre el período 1983–2025. Perón (tres presidencias: 1946–1952, 1952–1955, 1973–1974) es anterior a ese período y usa fuentes distintas. Los datos de Perón se presentan aquí como contrapunto histórico-cualitativo, no como punto de datos en la misma escala que los actores democráticos.
...
### 9. Qué sugiere el mapa orbital v0.2
...
El 86% de los documentos del corpus HCDN 1983–2025 y diez de las doce unidades de mandato muestran la pareja TEC–PAT. La excepción sostenida es Milei, con MES–TEC; Rodríguez Saá aporta el único caso PAT–MES a nivel de unidad. La dominancia de TEC–PAT atraviesa orientaciones políticas distintas sin agotar el campo de tres vectores.

**P2 — La pareja es más robusta que su dirección.**
Paternalismo + tecnocracia y tecnocracia + paternalismo no son intercambiables, pero la mayor masa no demuestra por sí sola qué vector encuadra al otro. De 12 unidades, cinco flechas se preservan, cinco quedan indeterminadas y dos muestran una dirección revisada. La dirección exige función discursiva, posición estructural y lectura de dependencia; no puede inferirse sólo por conteo.

**P3 — El mesianismo se concentra en rupturas; Milei podría convertirlo en meta-encuadre de gobierno ordinario.**
En el corpus democrático, MES aparece en inauguraciones bajo crisis, salidas bajo presión y momentos de crisis de régimen. Milei es la excepción provisional: la arquitectura `MES→TEC` reaparece en una asunción y en aperturas ordinarias. Esto permite formular una hipótesis de gobierno ordinario, todavía no una clasificación.
...
La rotación entre CFK I y CFK II, la diferencia de certeza entre Menem I y II, la inestabilidad de Alfonsín, la transición inaugural/apertura en Duhalde, la ambigüedad documental de Alberto Fernández y el debilitamiento de TEC en Perón entre 1946 y 1954 muestran que los perfiles no son tipos personales estables.
...
**La dirección estructural es exploratoria.** NB13 fue diseñado después del caso Milei y no constituye validación fuera de muestra. Sus firmas funcionales necesitan revisión ciega e intercoder agreement. `↔` expresa insuficiencia para ordenar; una dirección revisada no equivale a promoción.

**Milei n=2 canónico / tres discursos NB12.** La pareja MES–TEC es plausible y `MES→TEC` es internamente consistente, pero no puede establecerse como tipo de actor. La asunción 2023 debe integrarse formalmente a la misma línea cuantitativa y la apertura 2026 debe aportar prueba fuera de muestra.

**Macri provisional.** El perfil corregido es TIER_3 pendiente de re-run completo de pipeline v1; `PAT→TEC` es además una dirección revisada pendiente de codificación independiente.
...
**Rodríguez Saá requiere corrección upstream.** La ventana presidencial 1084–1112 se aplica sólo en NB13. NB04/NB10 todavía conservan el archivo de sesión completa y no deben usarse para fijar la dirección del caso.
...
> Fuente: `../empirical/mapa_orbital_v0_2/figures/MAPA_ORBITAL_COMPARABILITY_TIERS_v0_2.drawio.png`; datos HCDN de `MAPA_ORBITAL_CASE_UNITS_v0_2.csv` y casos Perón de `UNIFIED_CLEAN_CASE_MATRIX_v0_1.csv`.
> Uso: mostrar qué unidades pertenecen a cada tier y qué afirmaciones autoriza cada una sin recombinar mandatos.
> Caveat: NB13 no cambia el tier de evidencia; añade una capa de dirección dentro del corpus HCDN. El tier mide comparabilidad, no importancia histórica.
...
**Paso 5 — Ampliar el corpus Milei a n≥4.**
Integración formal del inaugural de diciembre 2023 —ya usado cualitativamente en NB12— a la misma pipeline cuantitativa de las aperturas 2024–2025, más la apertura de 2026. Con n≥4, la pareja MES–TEC y su dirección `MES→TEC` podrán evaluarse fuera de la muestra que ayudó a diseñar el instrumento.

**Paso 6 — Ejecutar la validación ciega y el re-run HCDN por actor × mandato.**
La validación debe revisar las firmas NB13, codificar independientemente Macri y los casos indeterminados, propagar la ventana presidencial de Rodríguez Saá, integrar Milei 2023 y reconstruir las agregaciones con Menem I/II y CFK I/II separados. El re-run post-corrección de Macri/Alberto Fernández debe producir outputs canónicos en la unidad correcta.
...
> Fuente: roadmap.json (datos del sitio, pendiente de actualización) · MAPA_ORBITAL_ARGENTINO_v0_2.md §8
...
El mapa orbital v0.2 muestra una estructura más compleja que v0.1. El 86% documental en la pareja tecnocracia/paternalismo sugiere una inercia del campo retórico, pero la auditoría demuestra que **pareja no equivale a flecha**. La masa identifica qué fuerzas están presentes; no siempre identifica cuál organiza a cuál. Separar mandatos revela rotaciones que el promedio personal borraba, como CFK I/II, y diferencias de certeza, como Menem I/II.

El mesianismo, menos frecuente, no debe reducirse a proxies religiosos ni a vocabulario de crisis. En Milei, la hipótesis `MES→TEC` emerge de una arquitectura: ruptura temporal, enemigo, misión, sacrificio y telos encuadran un programa técnico cuyos resultados retrovalidan la promesa. En Alfonsín y Rodríguez Saá, en cambio, la dirección permanece abierta o dependiente del episodio. El mismo vector cumple funciones distintas según la configuración y el contexto.
...
El propósito del proyecto no es etiquetar personas. Es entender configuraciones y trayectorias: qué dos fuerzas articula cada mandato, cuál organiza más que la otra, cuándo no pueden ordenarse y cómo cambia la relación con el contexto. Los tres cuerpos describen la inestabilidad del campo; no obligan a que cada presidente encarne una tríada. El mapa v0.2 es un instrumento de revisión. El mapa v1 sólo será posible cuando sus flechas, fuentes y puentes metodológicos hayan sido validados.

---

*Versión pública de trabajo v0.2 — producido 2026-08-04*
*Todos los perfiles son provisionales — no citar como clasificaciones históricas definitivas*
*La comparación numérica entre Perón y actores HCDN no está autorizada en este estado de la investigación*
*Base canónica: MAPA_ORBITAL_ARGENTINO_v0_1.md · UNIFIED_CLEAN_CORPUS_INTERPRETIVE_SYNTHESIS_v0_1.md*
*Capa metodológica v0.2: NB12 · NB13 · MAPA_ORBITAL_ARGENTINO_v0_2.md (NB14)*
*Proyecto El problema de los tres cuerpos argentinos*
