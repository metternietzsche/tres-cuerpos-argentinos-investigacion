...
const PUBLICATION_CACHE_KEY = '20260818g';
  ...
  return `<div id="inicio-page">
    ...
    <div id="inicio-hero">
      <div class="inicio-hero-inner">
        ...
        <div class="inicio-hero-eyebrow">PUBLICACIÓN ${esc(meta.site_release || 'v0.6.8')} · MAPA ${esc(meta.version || 'v0.4')} · CORPUS HCDN 1983–2026</div>
