...
const baseRoutes = [
  ...
  { file: 'empeza-aca.html', route: 'recorrido', title: 'Empezá acá', description: 'Un recorrido breve por la idea central, el mapa, la evidencia, las Leyendas y el videojuego.' },
  { file: 'tesis.html', route: 'tesis', title: 'La idea central', description: 'Por qué la política argentina no se reduce a un péndulo y cómo interactúan sus tres cuerpos.' },
